...
const AllocationIllustration = () => {
  ...
  return (
    <div className="relative w-full flex justify-center lg:justify-end mt-auto pointer-events-none p-0 opacity-80 origin-center lg:origin-bottom-right scale-[0.85] sm:scale-95 lg:scale-[1.1]">
...
const PerformanceIllustration = () => {
  ...
  return (
    <div className="relative w-full h-[120px] md:h-[180px] pointer-events-none opacity-80 z-0 mt-8">
      <svg width="100%" height="100%" viewBox="0 0 400 100" preserveAspectRatio="none" className="block">
        <defs>
        ...
        {/* Minimal horizontal baselines (vectorEffect ensures they stay thin) */}
        <line x1="0" y1="33" x2="400" y2="33" stroke={FILL} strokeWidth="1" strokeDasharray="2 4" opacity="0.1" vectorEffect="non-scaling-stroke" />
        <line x1="0" y1="66" x2="400" y2="66" stroke={FILL} strokeWidth="1" strokeDasharray="2 4" opacity="0.1" vectorEffect="non-scaling-stroke" />
      ...
      {/* Synchronized Pulse Dots (HTML to keep them perfectly circular) */}
...
const RiskIllustration = () => {
  return (
    <div className="relative w-full flex justify-center lg:justify-end mt-4 md:mt-8 pointer-events-none opacity-90 origin-center lg:origin-bottom-right scale-[0.85] sm:scale-95 lg:scale-[1.1]">
...
const DistributionIllustration = () => (
  <div className="relative w-full h-[150px] md:h-[180px] pointer-events-none opacity-80 flex items-end justify-center lg:justify-end px-0 pb-0 mt-8">
    <svg className="w-full h-full max-w-[700px]" viewBox="0 0 800 240" preserveAspectRatio="xMidYMid meet">
      {[...Array(5)].map((_, i) => (
        <motion.path
          key={i}
  ...
  return (
    <div className="min-h-screen selection:bg-aurix-ink selection:text-white bg-aurix-bg text-aurix-ink">
      ...
      >
        ...
        {/* Hero Section */}
        <section className="relative min-h-screen flex flex-col justify-center px-8 md:px-16 pt-32 pb-20 md:pt-32 md:pb-12 overflow-hidden bg-[#F4F4F7]">
          {/* Background Video */}
          <div className="hidden md:block absolute inset-0 z-0 overflow-hidden">
            <video
              ...
              className="absolute inset-0 w-full h-full object-right md:object-center object-cover z-[-5]"
            >
          ...
          <div className="flex-1 flex flex-col justify-center pb-8 md:pb-24">
            <div className="max-w-[1600px] mx-auto w-full relative z-10 lg:grid lg:grid-cols-2 gap-12 items-center">
              <motion.div
                ...
                className="max-w-lg mx-auto lg:mx-0 flex flex-col items-center lg:items-start text-center lg:text-left mb-6 lg:mb-0"
              >
                {/* Mobile Hero Image */}
                ...
                <h1 className="text-3xl md:text-5xl lg:text-[50px] font-bold tracking-tight leading-[1.05] mb-5 text-aurix-ink drop-shadow-[0_0_40px_rgba(255,255,255,1)] drop-shadow-[0_0_10px_rgba(255,255,255,0.7)]">
                  A vault-based capital allocator embedded in global commodities markets
                </h1>
                <p className="text-base md:text-lg text-aurix-muted mb-10 leading-relaxed font-medium drop-shadow-[0_0_30px_rgba(255,255,255,1)] drop-shadow-[0_0_5px_rgba(255,255,255,0.5)]">
              ...
              {/* Right side spacer for desktop to show background visual */}
              <div className="hidden lg:block h-[500px]" />
            </div>
          </div>

          {/* Metrics Bar - Bottom of Hero */}
          <div className="max-w-[1600px] mx-auto w-full mt-2 md:mt-12 relative z-10">
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              {[
                ...
                <div key={idx} className="bg-white/40 backdrop-blur-md border border-white/30 rounded-2xl p-6 flex flex-col items-center text-center gap-4 hover:bg-white/60 transition-all group shadow-sm transition-all duration-300 overflow-hidden">
                  <span className="text-[11px] font-bold uppercase tracking-[0.2em] text-aurix-muted/90 leading-tight">{metric.label}</span>
                  <span className={cn("text-2xl font-bold tracking-tight text-aurix-ink whitespace-nowrap")}>{metric.value}</span>
                </div>
              ))}
            </motion.div>
          </div>
        ...
        {/* About AURIX */}
        <section id="vaults" className="py-20 md:pt-24 md:pb-4 px-8 md:px-16 bg-transparent relative overflow-hidden">
          <BackgroundBlurs />
          <div className="max-w-[1600px] mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              ...
              <div className="order-2 text-center lg:text-left">
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-aurix-muted mb-2 block">Protocol Overview</span>
                <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">What is AURIX?</h2>
        ...
        {/* How it works */}
        <section className="py-20 md:pt-6 md:pb-4 px-8 md:px-16 bg-transparent relative overflow-hidden">
          <BackgroundBlurs />
          <div className="max-w-[1600px] mx-auto relative z-10 text-aurix-ink">
            <div className="mb-8 text-center lg:text-left flex flex-col items-center lg:items-start">
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-aurix-muted mb-2 block">Operational Flow</span>
              <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-4">How it works</h2>
              <p className="text-base md:text-lg text-aurix-muted max-w-2xl leading-relaxed font-medium text-center lg:text-left">
        ...
        <section id="strategy" className="py-20 md:pt-2 md:pb-10 px-8 md:px-16 bg-transparent relative overflow-hidden">
          <BackgroundBlurs />
          <div className="max-w-[1600px] mx-auto relative z-10">
            <div className="mb-8 text-center lg:text-left flex flex-col items-center lg:items-start">
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-aurix-muted mb-2 block">Strategy Framework</span>
              <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">How capital is deployed</h2>
              <p className="text-base md:text-lg text-aurix-muted max-w-3xl leading-relaxed font-medium text-center lg:text-left">
        ...
        {/* AI and Quant Layer */}
        <section className="py-20 md:py-24 px-8 md:px-16 bg-transparent border-y border-aurix-border relative overflow-hidden flex items-center justify-center min-h-[700px]">
          <BackgroundBlurs />
          {/* Quantitative Grid */}
        ...
        <section className="py-20 md:py-8 px-8 md:px-16 bg-aurix-ink border-y border-white/10 relative overflow-hidden text-white">
          {/* Subtle Background Pattern */}
          <div className="absolute inset-0 opacity-[0.07] pointer-events-none">
            <div className="absolute inset-0" style={{
              backgroundImage: `radial-gradient(circle, #ffffff 2px, transparent 1px)`,
          ...
          <div className="max-w-[1600px] mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24 items-center">
              <div className="text-center lg:text-left">
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-white/40 mb-2 block">Vault Mechanics</span>
                <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight text-white">Understanding vault participation</h2>
        ...
        {/* Performance and NAV */}
        <section id="performance" className="py-20 md:py-10 px-8 md:px-16 bg-transparent border-y border-aurix-border relative overflow-hidden">
          <BackgroundBlurs />
          <div className="max-w-[1600px] mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-20">
              <div className="lg:col-span-1 text-aurix-ink text-center lg:text-left">
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-aurix-muted mb-2 block">Performance Data</span>
                <h2 className="text-2xl md:text-4xl font-bold mb-4 tracking-tight text-aurix-ink">Performance reflects reality</h2>
                <div className="space-y-6 text-base md:text-lg text-aurix-muted leading-relaxed font-medium">
              ...
              <div className="lg:col-span-2 h-[350px] md:h-[600px] bg-white/40 backdrop-blur-xl border border-aurix-border p-6 md:p-12">
        ...
        {/* Risk Management */}
        <section id="risk" className="py-20 md:py-10 px-8 md:px-16 bg-transparent relative overflow-hidden">
          <BackgroundBlurs />
          <div className="max-w-[1600px] mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center">
              <div className="text-center lg:text-left">
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-aurix-muted mb-2 block">Risk Controls</span>
                <h2 className="text-3xl md:text-4xl font-bold mb-4 tracking-tight">Structure before exposure</h2>
                <div className="space-y-6 text-base md:text-lg text-aurix-muted leading-relaxed font-medium">
                  <p>
        ...
        <section className="py-20 md:py-10 px-8 md:px-16 bg-transparent border-y border-aurix-border relative overflow-hidden">
          <BackgroundBlurs />
          <div className="max-w-[1600px] mx-auto relative z-10">
            <div className="text-center lg:text-left mb-8 flex flex-col items-center lg:items-start">
              <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-aurix-muted mb-2 block">Transparency</span>
              <h2 className="text-4xl md:text-4xl font-bold mb-4 tracking-tight">Visibility into capital</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-2">
              {/* Card 1: Allocation */}
              <div className="lg:col-span-8 institutional-card group min-h-[400px] flex flex-col justify-between overflow-hidden">
                <div>
              ...
              {/* Card 2: Performance */}
              <div className="lg:col-span-4 institutional-card group min-h-[400px] flex flex-col justify-between overflow-hidden">
                <div>
              ...
              {/* Card 3: Risk */}
              <div className="lg:col-span-5 institutional-card group min-h-[400px] flex flex-col justify-between overflow-hidden">
                <div>
              ...
              {/* Card 4: Distribution */}
              <div className="lg:col-span-7 institutional-card group min-h-[400px] flex flex-col justify-between overflow-hidden">
                <div>
        ...
        {/* Why this Works */}
        <section className="py-20 md:py-10 px-8 md:px-16 bg-transparent relative overflow-hidden">
          <BackgroundBlurs />
          <div className="max-w-[1600px] mx-auto relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-24">
              <div className="text-center lg:text-left">
                <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-aurix-muted mb-2 block">Market Context</span>
        ...
        {/* Final CTA */}
        <section className="py-20 md:py-16 bg-transparent relative overflow-hidden flex justify-center">
